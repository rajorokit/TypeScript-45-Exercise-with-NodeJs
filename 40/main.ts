...
function make_album(artist_name: string, album_tite: string, tracks?: number){
...
let album2 = make_album("Hoorain", "Album Title 2");

// Calling a make album function with third parameter
let album3 = make_album("Hiba", "Album Title 3", 20);
